...
from app.schemas.metrics_schema import (
    MetadataThresholdCreate, MetadataThresholdUpdate, MetadataThresholdOut, MetadataThresholdListOut,
    ProfilingThresholdCreate, ProfilingThresholdUpdate, ProfilingThresholdOut, ProfilingThresholdListOut,
    AnomalyThresholdCreate, AnomalyThresholdUpdate, AnomalyThresholdOut, AnomalyThresholdListOut
)
...
@metrics_router.post("/metadata-thresholds", response_model=MetadataThresholdOut, status_code=status.HTTP_201_CREATED)
...
@metrics_router.get("/metadata-thresholds/{threshold_id}", response_model=MetadataThresholdOut)
...
@metrics_router.patch("/metadata-thresholds/{threshold_id}", response_model=MetadataThresholdOut)
...
@metrics_router.delete("/metadata-thresholds/{threshold_id}", status_code=status.HTTP_204_NO_CONTENT)
...
@metrics_router.post("/profiling-thresholds", response_model=ProfilingThresholdOut, status_code=status.HTTP_201_CREATED)
...
@metrics_router.get("/profiling-thresholds/{threshold_id}", response_model=ProfilingThresholdOut)
...
@metrics_router.patch("/profiling-thresholds/{threshold_id}", response_model=ProfilingThresholdOut)
...
@metrics_router.delete("/profiling-thresholds/{threshold_id}", status_code=status.HTTP_204_NO_CONTENT)
...
@metrics_router.post("/anomaly-thresholds", response_model=AnomalyThresholdOut, status_code=status.HTTP_201_CREATED)
...
@metrics_router.get("/anomaly-thresholds/{threshold_id}", response_model=AnomalyThresholdOut)
...
@metrics_router.patch("/anomaly-thresholds/{threshold_id}", response_model=AnomalyThresholdOut)
...
@metrics_router.delete("/anomaly-thresholds/{threshold_id}", status_code=status.HTTP_204_NO_CONTENT)
